(function ($) {
  ...
  function initGsapParallax() {
    ...
    $('.theme-btn,.theme-btn-s2, #change-theme-btn, .bigCursor').mouseenter(
      (e) => {
        gsap.to(ball, {
          duration: 0.3,
          scale: 3,
    ...
    $('.theme-btn,.theme-btn-s2, #change-theme-btn, .bigCursor').mouseleave(
      (e) => {
        gsap.to(ball, {
          duration: 0.3,
          scale: 0.5,
  ...
  function productGallary() {
    if (
      $('.tp-testimonial-active').length &&
      $('.tp-testimonial-thumbnil-active').length
    ) {
